...
// KPI
// ──────────────────────────────────────────────────────────────────
export async function fetchKpiDataClient(): Promise<KpiData> {
  ...
  const todayAreaM2 =
    todayAreaData?.reduce(
      (sum, m) => sum + ((m.area_cleaned_m2 as number | null) ?? 0),
      0,
    ) ?? 0;
...
// Robots
// ──────────────────────────────────────────────────────────────────
export async function fetchRobotsClient(): Promise<Robot[]> {
  const supabase = createClient();
...
// ──────────────────────────────────────────────────────────────────
export async function fetchComplexesClient(): Promise<Complex[]> {
  const supabase = createClient();
...
// Missions (최근 10건)
// ──────────────────────────────────────────────────────────────────
export async function fetchRecentMissionsClient(): Promise<Mission[]> {
  const supabase = createClient();
  ...
  return (data ?? []).map((m) => ({
    ...
    areaCleaned: (m.area_cleaned_m2 as number | null) ?? 0,
...
// ──────────────────────────────────────────────────────────────────
// Incidents (미해결 인시던트, 최근 6건)
// ──────────────────────────────────────────────────────────────────
export async function fetchOpenIncidentsClient(): Promise<Incident[]> {
  const supabase = createClient();
...
// ──────────────────────────────────────────────────────────────────
export async function fetchAlertConsumablesClient(): Promise<Consumable[]> {
  const supabase = createClient();
