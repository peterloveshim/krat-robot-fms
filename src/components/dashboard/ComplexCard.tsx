  ...
  return (
    <Card className="bg-krat-bg2 border-krat-border rounded-krat shadow-none">
      <CardContent className="p-4">
        ...
        <div className="text-[11px] text-krat-tx3 mb-3">
          {complex.district} · {complex.subtypeLabel}
        </div>
        <div className="flex gap-4">
          <div className="text-center">
            <div className="text-[18px] font-bold text-krat-green leading-none">
              {complex.robots.operating}
            </div>
            <div className="text-[10px] text-krat-tx3 mt-1">가동</div>
          </div>
          <div className="text-center">
            <div className="text-[18px] font-bold text-krat-accent leading-none">
              {complex.robots.charging}
            </div>
            <div className="text-[10px] text-krat-tx3 mt-1">충전</div>
          </div>
          <div className="text-center">
            <div
            ...
            <div className="text-[10px] text-krat-tx3 mt-1">에러</div>
          </div>
        </div>
      </CardContent>
    </Card>
